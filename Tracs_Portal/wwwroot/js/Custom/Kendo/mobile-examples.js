...
window.app = new kendo.mobile.Application($(document.body), {
    ...
    skin: "nova",
    icon: {
        "" : '@Url.Content("~/css/Custom/mobile/AppIcon72x72.png")',
        "72x72" : '@Url.Content("~/css/Custom/mobile/AppIcon72x72.png")',
        "76x76" : '@Url.Content("~/css/Custom/mobile/AppIcon76x76.png")',
        "114x114" : '@Url.Content("~/css/Custom/mobile/AppIcon72x72@2x.png")',
        "120x120" : '@Url.Content("~/css/Custom/mobile/AppIcon76x76@2x.png")',
        "152x152" : '@Url.Content("~/css/Custom/mobile/AppIcon76x76@2x.png")'
    }
});
